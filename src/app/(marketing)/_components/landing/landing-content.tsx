...
const HowItWorksSection = dynamic(() => import("./how-it-works-section").then((mod) => ({ default: mod.HowItWorksSection })), {
...
const CtaBannerSection = dynamic(() => import("./cta-banner-section").then((mod) => ({ default: mod.CtaBannerSection })), {
