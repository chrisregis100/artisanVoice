  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        className="relative overflow-hidden rounded-[2rem] border border-border/40 bg-card/60 shadow-[0_0_80px_-20px_rgba(5,150,105,0.3)] backdrop-blur-2xl"
      >
        <div className="flex items-center gap-2 border-b border-border/40 bg-card/40 px-4 py-3 backdrop-blur-md">
        ...
        <div className="flex h-[500px] bg-surface/40">
          <div className="hidden w-64 flex-col gap-6 border-r border-border/50 bg-card/40 p-6 sm:flex backdrop-blur-md">
            <div className="flex items-center gap-2">
              <BilloLogoMark className="h-8 w-8" size={32} />
              <span className="font-display font-bold text-foreground tracking-tight">Billo</span>
            </div>
            ...
            <div className="flex flex-col gap-1">
              ...
              <div className="flex items-center gap-3 rounded-lg px-3 py-2 text-muted-foreground transition-colors hover:bg-card/60 lg:hover:shadow-sm">
          ...
          <div className="flex-1 overflow-hidden p-6 sm:p-8">
            ...
            <div className="mt-8 grid grid-cols-1 gap-4 sm:grid-cols-3">
              <div className="flex flex-col gap-2 rounded-2xl border border-border/60 bg-card/70 p-5 shadow-sm backdrop-blur-md transition-shadow hover:shadow-md">
            ...
            <div className="mt-6 flex flex-col gap-4 rounded-2xl border border-border/60 bg-card/70 p-5 shadow-sm backdrop-blur-md">
              ...
              <div className="flex flex-col gap-3">
                {[1, 2, 3].map((i) => (
                  <div
                    key={i}
                    className="group flex items-center justify-between rounded-xl border border-border/40 bg-muted/50 p-3 transition-colors hover:bg-card"
                  >
