...
--
-- This version checks for an existing transaction BEFORE touching the wallet, so:
--   • Callers receive a clean return value (current balance) instead of an exception.
--   • The success-page fallback path can simply call grant_credits without catching 23505.
